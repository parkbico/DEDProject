package com.ded.admin.service.posts;


import com.ded.admin.domain.posts.Posts;
import com.ded.admin.domain.posts.PostsRepository;
...
public class PostsService {
    ...
    public PostsResponseDto findById(Long id){
        Posts entity = postsRepository.findById(id).orElseThrow(()->new IllegalArgumentException("해당 게시들이 없습니다. id="+id));
